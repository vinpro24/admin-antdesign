    ...
    <div className="App">
      <Layout>
        <Header style={{ padding: 10 }}>
          <Avatar style={{ float: 'right' }} src='https://github.com/Shrideep/react-antd-layout/blob/master/public/dp.png?raw=true' />
          ...
          <Layout>
            <Content style={{ padding: '0 50px' }}>
              ...
              <div style={{ background: '#fff', padding: 24, minHeight: 580 }}>
                <Cricketer name='Virat Kholi' team='IND' avatarSrc='https://github.com/Shrideep/react-antd-layout/blob/master/public/vk.jpg?raw=true'>
                ...
                <Cricketer name='Jasprit Bumrah' team='IND' avatarSrc='https://github.com/Shrideep/react-antd-layout/raw/master/public/jb.jpg'>
